...
function obtenerDatos(){
    ...
    let servicioCotizar = inputServicioCotizar.options[inputServicioCotizar.selectedIndex].text;
    ...
    if(error == true){
        ...
        let respuesta = registrarContacto(nombre, telefono, correo, servicioCotizar, mensaje, horaMensaje, fechaMensaje);
